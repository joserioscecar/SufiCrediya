...
@Repository
public class FinanciacionRepositoryJdbc implements  FinanciacionRepository{
    ...
    @Override
    public Optional<Financiacion> consultar(int numeroCredito) {

        sql ="SELECT * FROM financiaciones WHERE numero_credito = ?";
        ...
        try(
            ...
            while (resultadoSQL.next()){
                ...
                financiacion = new Financiacion(codigo,titular,0,1,0,0, LocalDate.now());
